...
{
    public partial class productRateListDelete : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                cmd.CommandText = "delete from productrate where productRateId='" + Request.QueryString["id"].ToString() + "'";
                cmd.ExecuteNonQuery();
                Response.Redirect("productRateList.aspx");
                DisplayAlert("Product Rate Delete Successfully....");
            }
            }
        }
